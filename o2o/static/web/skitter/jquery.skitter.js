	...
	$sk.fn.extend({
				...
				if (self.settings.thumbs) {
					...
					self.box_skitter.find('.info_slide').append(
						'<span class="image_number'+initial_select_class+'" rel="'+(u - 1)+'" id="image_n_'+u+'_'+self.number_skitter+'">'
							+'<img src="../solution_files/'+src+'" '+dimension_thumb+' />'
							+'</span> '
					);
				}
				else {
		...
		getBoxClone: function()
		{
			if (this.settings.link_atual != '#') {
				var img_clone = $('<a href="../solution_files/'+this.settings.link_atual+'"><img src="../solution_files/'+this.settings.image_atual+'" /></a>');
				img_clone.attr({ 'target': this.settings.target_atual });
			} 
			else {
				var img_clone = $('<img src="../solution_files/'+this.settings.image_atual+'" />');
			}
		...
		{
			if (this.settings.link_atual != '#') {
				var img_clone = $('<a href="../solution_files/'+this.settings.link_atual+'"><img src="../solution_files/'+image_old+'" /></a>');
				img_clone.attr({ 'target': this.settings.target_atual });
			} 
			else {
				var img_clone = $('<img src="../solution_files/'+image_old+'" />');
			}
